...
namespace Day2Assignment
{
    class Person
    {
        ...
        public string ScreenName
        {
            get
            {
                return this.FirstName + "_" + DateOfBirth.Day.ToString() + "_" + DateOfBirth.Month.ToString();
            }
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"{person_.FirstName}\n{person_.LastName}\n{person_.EmailAddress}\n{person_.DateOfBirth}\n{person_.IsAdult}\n{person_.SunSign}\n{person_.ChineseZodiacSign}\n{person_.IsBirthDay}\n{person_.ScreenName}");
            Console.ReadKey();
        }
    }
}
